...
function ArticlePage() {
  ...
  const handleNoteSubmit = async (e) => {
    ...
    try {
      await GetNewsService.createNote(noteBody.id, noteBody.content);
    } catch (error) {
      console.log("ups", error);
    }
    clearInputs();
      ...
      <div className="articlePageContainer">
        <div className="articleContainer">
          ...
          <div className="imgContainer">
            <div className="image block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 mb-9">
              <a href="#!">
                <img
          ...
          <p>{article.content}</p>
          <h3 className="mt-5 flex justify-end mr-44">
            publishing date: {article.articleId}
          </h3>
          ...
          <div className="comments">
            ...
            <textarea
              ...
              value={comment}
              className="input bg-slate-100 mt-5"
              name=""
              id=""
              cols="80"
              rows="10"
          ...
          <div className="AnalyticalNote text-center ">
            <div>
              ...
              <textarea
                ...
                value={note}
                className="input bg-slate-100 mt-5 p-3"
                name=""
                id=""
                cols="80"
                rows="20"
            ...
            <div className="tags mb-5 mt-5 ">
              {/* <label htmlFor=""></label> */}
              <input
                className="inputs rounded-lg text-center"
                type="text"
                name=""
                id=""
                placeholder="tags"
            ...
            <div className="socialShare flex gap-5 justify-center mb-5">
              ...
              <TwitterShareButton url="placebo.mk" title={note}>
                <TwitterIcon size={32} round={true} />
              </TwitterShareButton>
              <VKShareButton url="placebo.mk" title={note}>
            ...
            <div className="btns flex justify-around">
              <button
                ...
                className="px-3 text-center rounded-lg"
              >
                Save note
              </button>
            </div>
